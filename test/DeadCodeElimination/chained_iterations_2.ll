; RUN: opt -S %loadPolly -basicaa -polly-ast -analyze < %s | FileCheck %s
; RUN: opt -S %loadPolly -basicaa -polly-dce -polly-ast -analyze < %s | FileCheck %s -check-prefix=CHECK-DCE
