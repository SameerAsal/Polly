...
typedef long long int Value_poly;
...
#define VALUE_TO_LONG(val) \
    ((long)((val)>(Value_poly)LONG_MIN&&(val)<=(Value_poly)LONG_MAX)?\
     (val):(THROW(overflow_error), LONG_MIN))

#define VALUE_TO_INT(val) \
    ((int)((val)>(Value_poly)INT_MIN&&(val)<=(Value_poly)INT_MAX)?\
...
typedef union { char *s; long l; int i; float f; double d;} Value_poly;
#define VALUE_FMT "%s"
#define VALUE_CONST(val) ((Value)(val))
#define VALUE_NAN ((Value_poly)(long)0xdadeebee)
#define VALUE_MIN ((Value_poly)(long)0xdeadbeef)
#define VALUE_MAX ((Value_poly)(long)0xfeedabee)
#define VALUE_ZERO ((Value_poly)0)
#define VALUE_ONE  ((Value_poly)1)
#define VALUE_MONE ((Value_poly)-1)
...
#define value_swap(v1,v2)          {Value_poly tmp; tmp = v2; \
                                    v2 = v1; v1 = tmp;   \
                                   }

/* Boolean operators on 'Value_poly' */
...
/* Conditional operations on 'Value_poly' */
...
/* Binary operations on 'Value_poly' */
...
#define value_assign(v1,v2)        ((v1)  = (v2))
#define value_set_si(val,i)        ((val) = (Value_poly)(i))   
#define value_set_double(val,d)    ((val) = (Value_poly)(d)) 
#define value_clear(val)           ((val) = 0)
...
#define int_to_value(i) ((Value_poly)(i))
#define long_to_value(l) ((Value_poly)(l))
#define float_to_value(f) ((Value_poly)(f))
#define double_to_value(d) ((Value_poly)(d))
...
/* Binary operators on 'Value_poly' */
...
#define value_addto(ref,val1,val2) 	((ref) = (val1)+(val2))
#define value_add_int(ref,val,vint)     ((ref) = (val)+(Value_poly)(vint))
#define value_addmul(ref, val1, val2)   ((ref) += (val1)*(val2))
...
#define value_subtract(ref,val1,val2) 	((ref) = (val1)-(val2))
#define value_sub_int(ref,val,vint)     ((ref) = (val)-(Value_poly)(vint))
...
#endif /* 'Value_poly' set to |longlong|long|float|char *|int */
...
#define value_fake_binary(v1,v2) ((Value_poly)((v1).i+(v2).i))
#define value_bool_binary(v1,v2) ((int)((v1).i+(v2).i))
#undef float_to_value
#define float_to_value(f) ((Value_poly)f)
#undef double_to_value
#define double_to_value(f) ((Value_poly)f)
#undef value_uminus
