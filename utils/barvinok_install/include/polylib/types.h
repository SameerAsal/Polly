...
typedef struct interval {
  Value_poly MaxN, MaxD;
  Value_poly MinN, MinD; 
  int MaxI, MinI;
} Interval;
...
/*     e->pos  = [1..nb_param]                                            */
/*     e->arr[i].d = denominator (Value_poly)                                  */
/*     e->arr[i].x.p = pointer to another enode (if denominator is zero)  */
/*     e->arr[i].x.n = numerator (Value_poly) (if denominator is non-zero)     */
/*------------------------------------------------------------------------*/
