...
extern Polyhedron *AddConstraints(Value_poly *Con,unsigned NbConstraints,
				   Polyhedron *Pol,unsigned NbMaxRays );
extern Polyhedron *AddPolyToDomain(Polyhedron *Pol,Polyhedron *PolDomain);
extern Polyhedron *AddRays (Value_poly *Ray2,unsigned NbRay2,Polyhedron
...
extern Interval *DomainCost(Polyhedron *Pol,Value_poly *Cost);
...
extern int lower_upper_bounds(int pos,Polyhedron *P,Value_poly *context,
			      Value_poly *LBp,Value_poly *UBp);
...
extern Polyhedron *SubConstraint(Value_poly *Con,Polyhedron *Pol,
