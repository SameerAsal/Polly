...
void barvinok_count(Polyhedron *P, Value_poly* result, unsigned NbMaxCons);
void barvinok_count_with_options(Polyhedron *P, Value_poly* result,
...
void zz2value(const ZZ& z, Value_poly& v);
