...
typedef struct _evalue {
  Value_poly d;              /* denominator */
  union {
    Value_poly n;            /* numerator (if denominator > 0) */
...
void evalue_set(evalue *ev, Value_poly n, Value_poly d);
...
int in_domain(Polyhedron *P, Value_poly *list_args);
double compute_evalue(const evalue *e, Value_poly *list_args);
Value_poly *compute_poly(Enumeration *en,Value_poly *list_args);
evalue *evalue_eval(const evalue *e, Value_poly *values);
...
void evalue_denom(const evalue *e, Value_poly *d);
void evalue_div(evalue *e, Value_poly n);
void evalue_mul(evalue *e, Value_poly n);
void evalue_mul_div(evalue *e, Value_poly n, Value_poly d);
void evalue_negate(evalue *e);
void evalue_add_constant(evalue *e, const Value_poly cst);
void evalue_split_domains_into_orthants(evalue *e, unsigned MaxRays);
void evalue_extract_affine(const evalue *e, Value_poly *coeff, Value_poly *cst, Value_poly *d);
evalue *affine2evalue(Value_poly *coeff, Value_poly denom, int nvar);
